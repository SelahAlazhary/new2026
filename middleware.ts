...
const CSP = [
  ...
  "connect-src 'self' https://*.firebaseio.com https://*.googleapis.com https://oauth2.googleapis.com https://accept.paymob.com",
  "frame-src 'self' https://www.youtube.com https://www.youtube-nocookie.com https://drive.google.com https://player.vimeo.com https://iframe.mediadelivery.net https://meet.google.com https://calendar.google.com https://accept.paymob.com",
  "worker-src 'self'",
  "manifest-src 'self'",
