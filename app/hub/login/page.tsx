  ...
  return (
    <main className="grid min-h-dvh place-items-center bg-gradient-to-b from-slate-50 to-white px-5 py-10">
      <div className="w-full max-w-sm space-y-1">
        <div className="rounded-3xl border border-slate-200/80 bg-white p-8 shadow-xl shadow-slate-900/[0.08]" data-reveal="scale-up">
        ...
        <p className="text-center text-[11px] text-slate-400 pt-3" data-reveal="fade" data-reveal-delay="3">
